...
import { ADMIN_ROLE, INIT_PERMISSIONS, USER_ROLE } from './simple';
        ...
        if(Boolean(isInit)){
            ...
            if(countUser===0){
              ...
              await this.userModel.insertMany([
                ...
                {
                    name: "Nguyễn Hải Triều",
                    email: "trieunguyenbaby13@gmail.com",
                    password: this.userService.hashPassword(this.configService.get<string>("INIT_PASSWORD")),
                    age: 96,
                    gender: "MALE",
                    address: "VietNam",
            ...
            if(countUser>0 && permissionCount>0 && roleCount>0){
